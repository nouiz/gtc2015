...
\begin{frame}{High level (2)}
  Theano <- \{Pylearn2, blocks, PyMC 3, lasagne, sklearn-theano, theano-rnn, Morb, ...\}
  \newline
  \newline
  \newline
...
\begin{frame}{Some models build with Theano}
  ...
  \item SVM
  \item \begin{bf}many variations of above models\end{bf}
  \end{itemize}
\end{frame}
...
\item lenet (LeNet5 model to quickly play with a CNN)
\end{itemize}
\end{frame}
